import {ClickableCanvasState, LocationProps, MapClickReducerArgs, ClickableCanvasProps} from '../common/types'
...
export default (oldState: ClickableCanvasState, args: MapClickReducerArgs ): ClickableCanvasState => {
  ...
  switch (oldState.clicks) {
    case 0:
      return {...oldState, clicks: oldState.clicks+1, start: newState}

    case 1:
      return {...oldState, clicks: oldState.clicks+1, end: newState, text: TravelCalculator(oldState.start, newState, mapView)}
